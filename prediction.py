...
class MultiClassObj:
    def __init__(self, imagePath, modelPath):
        ...
        self.class_names_mapping = {1:"with_helmet"}
        #self.class_names_mapping = {1: "motorcycle", 2: "with_helmet", 3: "without_helmet" }
    ...
    def getPrediction(self):
        ...
        top_scores = [e for l2 in scores for e in l2 if e > 0.90]
        ...
        opencodecbase64 = encodeImageIntoBase64('output.jpg')
        ...
        listOfOutput.append({"image": opencodecbase64.decode('utf-8')})
        return listOfOutput
